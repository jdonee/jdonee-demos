...
<body>
	...
	<form id="inputForm" action="${ctx}/task/${action}" method="post" class="form-horizontal">
		...
		<fieldset class="scheduler-border">
			<legend class="scheduler-border"><small>管理任务</small></legend>
			<div class="control-group">
				<label for="task_title" class="control-label">任务名称:</label>
				<div class="controls">
					<input type="text" id="task_title" name="title"  value="${task.title}" class="form-control input-sm required" minlength="3"/>
				</div>
			</div>	
			<div class="control-group">
				<label for="description" class="control-label">任务描述:</label>
				<div class="controls">
					<textarea id="description" name="description" class="form-control input-sm">${task.description}</textarea>
				</div>
			</div>	
